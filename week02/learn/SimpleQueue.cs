public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: index [1] -> [0] (remove the first item)
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Insert(0, value) -> inserts value at the beginning
        // changed to Add(value) -> inserts value at the end
